...
from data_process.tools import get_road_name
...
class ROUTE(nn.Module):
    def __init__(self, n_input=9, output_dim=2, t=5, n_grid=27, n_spatial_layer=3, n_temporal_layer=3, emb_dim=32,
                 n_head=8, drop_rate=0.1,
    ...
    def train_multi_second(self):
        ...
        milestones_1 = [20, 100, 200, 500, 800, 1200, 1600, 2000, 2500]
    ...
    def multi_test(self, epoch=0):
        ...
        print("the average loss is ", position_loss)
        print("speed loss is ", speed_loss)
        # with open("route_loss.json", 'w') as f:
    ...
    def statistic_position(self, real_position, fake_position):
        _100 = []
        _80 = []
        _60 = []
        _20 = []
        ...
        for i in range(real_position.shape[0]):
            error = np.sqrt(
                (real_position[i, 0] - fake_position[i, 0]) ** 2 + (real_position[i, 1] - fake_position[i, 1]) ** 2
            )
            ...
            if error > 100:
                ...
                _0.append(error)
        print("> 100 is {}".format(len(_100)))
        print("> 80 is {}".format(len(_80)))
        print("> 60 is {}".format(len(_60)))
        print("> 20 is {}".format(len(_20)))
        print("> 0 is {}".format(len(_0)))

    def statistic_speed(self, real_speed, fake_speed):
        _10 = []
        _8 = []
        _6 = []
        _3 = []
        _0 = []
        for i in range(real_speed.shape[0]):
            error = np.abs(real_speed[i] - fake_speed[i])
            print(error)
            if error > 10:
                _10.append(error)
            elif error > 8:
                ...
                _0.append(error)
        print("> 10 is {}".format(len(_10)))
        print("> 8 is {}".format(len(_8)))
        print("> 6 is {}".format(len(_6)))
        print("> 3 is {}".format(len(_3)))
        print("> 0 is {}".format(len(_0)))
